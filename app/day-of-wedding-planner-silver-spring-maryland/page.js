...
export const metadata = {
  title:
    'Day-of Wedding Planner in Silver Spring for Orchestrating Your Perfect Day',
  description:
    "Looking for a professional wedding planner in Silver Spring? We'll make your wedding a memorable and enjoyable celebration for everyone! Book a call today!",
  alternates: {
    canonical:
      'https://monicabrowneweddings.com/day-of-wedding-planner-silver-spring-maryland',
  },
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://monicabrowneweddings.com/day-of-wedding-planner-silver-spring-maryland',
...
export default async function WeddingPlannerSilverSpringMD() {
  return (
    <div>
      <Hero
        herotext="Day of Wedding Planner in Silver Spring for Elegant & Timeless Celebrations"
            ...
            <div className="py-10 md:py-20">
              <div className="max-w-3xl mx-auto">
                <h2 className="text-3xl lg:text-5xl my-8 text-center">
                  A Day-of Wedding Planner in Silver Spring, MD, Bringing Your
        ...
        <section className="bg-slate-800">
          <div className="max-w-3xl mx-auto py-10 md:py-20 text-white px-6">
            <h2 className="text-3xl md:text-5xl mb-8 text-center">
              Planning a Wedding in Silver Spring? Let Monica Help!
            </h2>
            <p className="md:text-xl mb-4">
            ...
            <div className="my-10">
              ...
              <p className="md:text-xl mb-4 ml-4">
                You've meticulously crafted your Silver Spring wedding plans,
                and we're here to bring that vision to life with precision. From
                our initial discussions, we’ll thoroughly understand your
          ...
          <section className="bg-slate-50">
            <div className="max-w-2xl mx-auto py-10 md:py-20 px-6">
              <h2 className="text-3xl md:text-5xl text-center">
                Monica Makes Planning Weddings for Silver Spring Couples Easy!
              </h2>
              <div className="my-10">
        ...
        <div className="container max-w-5xl mx-auto px-6">
          <section>
            <div className="max-w-2xl mx-auto py-10 md:py-20">
              <h2 className="text-3xl md:text-5xl mb-8 text-center">
                Why Should Couples in Silver Spring Hire Monica Browne Weddings?
              </h2>
              <p className="md:text-xl mb-4">
          ...
          <section>
            <div className="max-w-3xl mx-auto py-10">
              ...
              <h3 className="text-2xl md:text-3xl my-4">
                #1. What is the average cost of a wedding in Silver Spring, MD?
              </h3>
              <p className="md:text-xl mb-4">
                The cost of a wedding in Silver Spring, MD, can vary greatly
                depending on the size, style, and services you choose. On
                average, couples spend between{' '}
