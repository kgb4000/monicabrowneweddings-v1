  ...
  return (
    <>
      <Hero
        ...
        heroSubText="We take care of everything behind the scenes and help you plan the wedding of your dreams"
          ...
          <section>
            <div className="max-w-3xl mx-auto">
              ...
              <p className="md:text-xl mb-4">
                ...
                time-consuming, especially when you already have a busy life.
              </p>
              <p className="md:text-xl mb-4">
              ...
              <section>
                <div className="grid lg:grid-cols-3 gap-2 py-10">
                  <img
